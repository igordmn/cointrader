...
data class TestConfig(
        ...
        val altCoins: List<String> = listOf("USDT", "ETH", "MCO", "NEO", "OMG", "QTUM", "STRAT", "XVG", "DASH", "ETC", "SNT", "TRX"),
        ...
        val endTime: Instant = Instant.now() - Duration.ofDays(1),
        val startTime: Instant = endTime - Duration.ofDays(5)
)