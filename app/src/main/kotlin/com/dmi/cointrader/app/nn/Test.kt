...
import com.dmi.cointrader.app.moment.MomentsConfig
...
fun main(args: Array<String>) {
    runBlocking {
        ...
        val moments = momentArray(Paths.get("D:/yy/moments"), momentsConfig)
        val momentsSource = MomentSource(momentsConfig, currentTime, coinToTrades)
