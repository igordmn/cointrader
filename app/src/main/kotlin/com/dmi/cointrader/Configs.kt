...
//                        "VEN", "XMR", "BCPT", "GVT", "LSK", "DGD", "ADA", "XLM", "ICX", "NEBL", "INS", "IOST", "NANO", "NCASH", "ZIL"
                        "USDT", "ETH", "LTC", "NEO", "BCC", "MCO", "WTC", "QTUM", "OMG", "STRAT", "BQX", "IOTA", "LINK", "XVG", "MTL", "SUB",
                        "EOS", "ETC", "ENG", "DASH", "BTG", "TRX", "POWR", "XRP", "ENJ", "VEN", "RCN", "NULS", "XMR", "BCPT", "GVT", "LSK",
                        "DGD", "ADA", "XLM", "WAVES", "ICX", "ELF", "AION", "NEBL", "IOST", "NANO", "NCASH", "ZIL", "ONT", "STORM"
                )
        ),
...
data class TrainConfig(
        val range: InstantRange = ISO_LOCAL_DATE_TIME.parseInstantRange("2017-07-01T00:00:00", "2018-04-16T16:40:00", zoneOffset("+3")),
        val testDays: Double = 60.0,
        val validationDays: Double = 5.0,
