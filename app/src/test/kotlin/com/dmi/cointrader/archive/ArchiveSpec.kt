...
class ArchiveSpec : Spec() {
    ...
    init {
        ...
        "USDT asset (normal market)" - {
            val assets = TradeAssets(main = "BTC", alts = listOf("USDT"))
            val space = PeriodSpace(instant(1502942428322L), minutes(5))
            val expectedSpreads = listOf(
                    listOf(Spread(1 / 4261.48000000, 1 / 4261.48000000)),  // 0 1502942428322
                    listOf(Spread(1 / 4261.48000000, 1 / 4261.48000000)),  // 1 1502942728322
                    listOf(Spread(1 / 4261.48000000, 1 / 4261.48000000)),  // 2 1502943028322
                    listOf(Spread(1 / 4261.48000000, 1 / 4261.48000000)),  // 3 1502943328322
                    listOf(Spread(1 / 4261.48000000, 1 / 4264.88000000)),  // 4 1502943628322
                    listOf(Spread(1 / 4264.88000000, 1 / 4266.29000000))   // 5 1502943928322
            )
            ...
            /*
                ...
                1502942432285 4261.48000000 1.60000000 maker-buyer
                1502942432322 4261.48000000 0.07518300 maker-seller
                1502942568879 4280.56000000 0.02960000 maker-seller
                1502942568887 4280.56000000 0.23147400 maker-seller
                1502942628038 4261.48000000 0.00023400 maker-seller
                1502942628046 4261.48000000 0.00211300 maker-seller
                1502942637667 4261.48000000 0.00966100 maker-seller
                1502942647778 4261.48000000 0.14079600 maker-seller
                Spread(4261.48000000, 4261.48000000)          // 1 1502942728322
                Spread(4261.48000000, 4261.48000000)          // 2 1502943028322
                Spread(4261.48000000, 4261.48000000)          // 3 1502943328322
                1502943468063 4261.48000000 0.05976000 maker-seller
                1502943468063 4264.88000000 0.01569500 maker-seller
                1502943540055 4261.48000000 0.00701500 maker-seller
                1502943545980 4261.48000000 0.00298500 maker-seller
                1502943578118 4261.48000000 0.12963900 maker-buyer
                1502943578126 4261.48000000 0.11955800 maker-buyer
                1502943578132 4261.48000000 0.15001400 maker-buyer
                1502943600073 4264.88000000 0.50829100 maker-seller
                1502943600081 4264.88000000 0.45807300 maker-seller
                1502943600089 4264.88000000 0.51665000 maker-seller
                Spread(4264.88000000, 4261.48000000)          // 4 1502943628322
                1502943668410 4264.88000000 0.65146000 maker-buyer
                1502943668419 4264.88000000 0.06274900 maker-buyer
                1502943668427 4264.88000000 0.06787000 maker-buyer
                1502943673349 4266.29000000 0.02033700 maker-seller
                Spread(4266.29000000, 4264.88000000)          // 5 1502943928322
             */
        }
    }
}