...
class ArchiveSpec : Spec({
    "reversed assets" - {
        ...
        val newArchive = suspend {
            archive(
                    PeriodSpace(instant(1500005040000L), minutes(5)),
                    TradeAssets(main = "BTC", alts = listOf("ETH", "NEO", "LTC")),
        ...
        "reuse" {
            val archive1 = newArchive()
            archive1.sync(currentPeriod = 9)

            val archive2 = newArchive()
        ...
        /*
            ...
            Spread(0.08000000, 0.08000000)          // 0 1500005040000
            ...
            Spread(0.08000000, 0.08000000)          // 1 1500005340000
            ...
            Spread(0.08640000, 0.08600000)          // 2 1500005640000
            ...
            Spread(0.08640000, 0.08547900)          // 3 1500005940000
            ...
            Spread(0.08600000, 0.08527400)          // 4 1500006240000
            ...
            Spread(0.08600000, 0.08543200)          // 5 1500006540000
            ...
            Spread(0.08618000, 0.08585100)          // 7 1500007140000
            ...
            Spread(0.08636000, 0.08623400)          // 8 1500007440000
            ...
            Spread(0.08638000, 0.08631900)          // 10 1500008040000


            NEO
            1500004832141 0.00375000 20.00000000 maker-seller
            Spread(0.00375000, 0.00375000)          // 0 1500005040000
            Spread(0.00375000, 0.00375000)          // 1 1500005340000
            ...
            Spread(0.00261000, 0.00261000)          // 2 1500005640000
            1500005732141 0.00257000 2.00000000 maker-buyer
            1500005920297 0.00257000 2.00000000 maker-buyer
            Spread(0.00257000, 0.00257000, 0.00257000)          // 3 1500005940000
            ...
            Spread(0.00257000, 0.00265000, 0.00257000)          // 4 1500006240000
            ...
            Spread(0.00258600, 0.00258600, 0.00253800)          // 5 1500006540000
            ...
            Spread(0.00258700, 0.00259000, 0.00258700)          // 6 1500006840000
            ...
            Spread(0.00254500, 0.00263900, 0.00254500)          // 10 1500008040000


            LTC
            Spread(0.01900000, 0.01900000, 0.01900000)          // 0 1500005040000
            Spread(0.01900000, 0.01900000, 0.01900000)          // 1 1500005340000
            1500005394457 0.01900000 20.00000000 maker-buyer
            1500005536859 0.01909900 1.59000000 maker-buyer
            Spread(0.01909900, 0.01909900, 0.01900000)          // 2 1500005640000
            Spread(0.01909900, 0.01909900, 0.01909900)          // 3 1500005940000
            1500006066191 0.01914800 1.90000000 maker-buyer
            Spread(0.01914800, 0.01914800, 0.01914800)          // 4 1500006240000
            Spread(0.01914800, 0.01914800, 0.01914800)          // 5 1500006540000
            Spread(0.01914800, 0.01914800, 0.01914800)          // 6 1500006840000
            1500007121710 0.01909600 13.75000000 maker-buyer
            Spread(0.01909600, 0.01909600, 0.01909600)          // 7 1500007140000
            Spread(0.01909600, 0.01909600, 0.01909600)          // 8 1500007440000
            1500007691579 0.01932900 4.79000000 maker-buyer
            Spread(0.01932900, 0.01932900, 0.01932900)          // 9 1500007740000
            1500007884037 0.01922300 3.87000000 maker-buyer
            Spread(0.01922300, 0.01922300, 0.01922300)          // 10 1500008040000
        */
    }
